cat Chinese_brain_significant.txt | awk '!a[$1]++' | grep -v X | awk '{print $1,$2}' | while read gene chr; do 
    cat Chinese_brain_significant.txt | awk '$1=="'$gene'"{print $8,$13}' >"$gene".txt; 
